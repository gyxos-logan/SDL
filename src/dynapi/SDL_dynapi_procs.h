...
SDL_DYNAPI_PROC(SDL_GPUResourceHandle*,SDL_AllocateGPUResourceSampler,(SDL_GPUDevice *a,SDL_GPUResourceSet *b,SDL_GPUSampler *c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL_GPUResourceHandle*,SDL_AllocateGPUResourceSampledTexture,(SDL_GPUDevice *a,SDL_GPUResourceSet *b,SDL_GPUTexture *c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL_GPUResourceHandle*,SDL_AllocateGPUResourceStorageTexture,(SDL_GPUDevice *a,SDL_GPUResourceSet *b,SDL_GPUTexture *c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL_GPUResourceHandle*,SDL_AllocateGPUResourceStorageBuffer,(SDL_GPUDevice *a,SDL_GPUResourceSet *b,SDL_GPUBuffer *c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_ResolveGPUResource,(SDL_GPUCommandBuffer *a,SDL_GPUResourceHandle *b,Uint32 *c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_ReleaseGPUResource,(SDL_GPUDevice *a,SDL_GPUResourceHandle *b),(a,b),)
