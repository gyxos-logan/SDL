...
SDL_DYNAPI_PROC(SDL_GPUResource*,SDL_AllocateGPUResource,(SDL_GPUDevice *a,SDL_GPUResourceSet *b),(a,b),return)
SDL_DYNAPI_PROC(void,SDL_ReleaseGPUResource,(SDL_GPUDevice *a, SDL_GPUResource *b),(a,b),)
SDL_DYNAPI_PROC(void,SDL_SetGPUResourceSampler,(SDL_GPUDevice *a, SDL_GPUResource *b,SDL_GPUSampler *c),(a,b,c),)
SDL_DYNAPI_PROC(void,SDL_SetGPUResourceSampledTexture,(SDL_GPUDevice *a, SDL_GPUResource *b,SDL_GPUTexture *c),(a,b,c),)
SDL_DYNAPI_PROC(void,SDL_SetGPUResourceStorageTexture,(SDL_GPUDevice *a, SDL_GPUResource *b,SDL_GPUTexture *c),(a,b,c),)
SDL_DYNAPI_PROC(void,SDL_SetGPUResourceStorageBuffer,(SDL_GPUDevice *a,SDL_GPUResource *b,SDL_GPUBuffer *c),(a,b,c),)
SDL_DYNAPI_PROC(void,SDL_BindGPUResourceSet,(SDL_GPUCommandBuffer *a,SDL_GPUResourceSet *b,bool c),(a,b,c),)
SDL_DYNAPI_PROC(bool,SDL_ResolveGPUResource,(SDL_GPUCommandBuffer *a,SDL_GPUResource *b,Uint32 *c),(a,b,c),return)
