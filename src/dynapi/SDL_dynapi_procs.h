...
SDL_DYNAPI_PROC(void,SDL_BindGPUResourceSet,(SDL_GPUCommandBuffer *a,SDL_GPUResourceSet *b),(a,b),)
SDL_DYNAPI_PROC(void,SDL_ReleaseGPUResourceSet,(SDL_GPUDevice *a, SDL_GPUResourceSet *b),(a,b),)
SDL_DYNAPI_PROC(SDL_GPUResourceID,SDL_AllocateGPUResourceSampler,(SDL_GPUDevice *a,SDL_GPUResourceSet *b,SDL_GPUSampler *c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL_GPUResourceID,SDL_AllocateGPUResourceTexture,(SDL_GPUDevice *a,SDL_GPUResourceSet *b,SDL_GPUTexture *c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL_GPUResourceID,SDL_AllocateGPUResourceStorageTexture,(SDL_GPUDevice *a,SDL_GPUResourceSet *b,SDL_GPUTexture *c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL_GPUResourceID,SDL_AllocateGPUResourceStorageBuffer,(SDL_GPUDevice *a,SDL_GPUResourceSet *b,SDL_GPUBuffer *c),(a,b,c),return)
SDL_DYNAPI_PROC(bool,SDL_ResolveGPUResource,(SDL_GPUCommandBuffer *a,SDL_GPUResourceSet *b,SDL_GPUResourceID c,Uint32 *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(void,SDL_ReleaseGPUResource,(SDL_GPUDevice *a,SDL_GPUResourceSet *b,SDL_GPUResourceID c),(a,b,c),)
